...
const experiences = [
  ...
  achievements: [
    "Architected Trino-Hive data architecture for data insights platform",
    "Developed scalable data pipelines using PySpark for processing large financial datasets",
    "Implemented Kubernetes-based infrastructure for containerized data processing workloads",
  ],
  technologies: [
    "Kubernetes",
    "PySpark",
  ...
  responsibilities: [
    "Design and implement data pipelines for investment insights and analytics",
    "Contribute to Trino-Hive architecture for efficient data querying and processing",
    "Deploy and manage containerized applications using Kubernetes",
    "Collaborate with investment team to understand data requirements and deliver solutions",
...
},
  {
    ...
    technologies: ["Python", "Selenium", "Playwright", "Docker", "Apache Airflow", "Allure"],
    responsibilities: [
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 sm:gap-8">
            {experiences.map((exp, index) => (
              <Card
                key={index}
                className="p-4 sm:p-6 bg-card border-border cursor-pointer hover:border-accent/50 transition-all duration-300 hover:shadow-lg hover:shadow-accent/10"
